...
void obj_face_node_print ( int face_num, int order_max, vector<int> face_order,
...
void obj_normal_vector_print ( int normal_num, vector<double> normal_vector )
...
void obj_node_xyz_print ( int node_num, vector<double> node_xyz )
...
void obj_size ( std::string filename, int *node_num, int *face_num, int *normal_num,
  int *order_max )
...
//  Parameters:
//
//    Input, std::string FILENAME, the input file name.
//
...
void obj_size_print ( std::string filename, int node_num, int face_num,
...
//  Parameters:
//
//    Input, std::string FILENAME, the name of the file.
//
...
void obj_write ( std::string output_filename, int node_num, int face_num,
...
//  Parameters:
//
//    Input, std::string OUTPUT_FILENAME, the name of the output file.
//
...
//  Parameters:
//
//    Input, std::string S, the std::string to be examined.
//
